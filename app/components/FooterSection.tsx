...
export default function FooterSection() {
  ...
  return (
    <footer className="bg-[#F5F2ED]">
      ...
      <div
        className="px-6 -mt-3 md:mt-0 py-10 md:py-12 lg:px-24"
      ...
      >
        <div className="mx-auto max-w-7xl w-full">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 lg:gap-12 place-items-center lg:place-items-start">
            ...
            <div
              className={`flex flex-col w-full ${isAr ? "max-lg:items-center max-lg:text-center lg:items-start lg:text-right" : "items-center text-center lg:items-start lg:text-left"}`}
            >
            ...
            <div
              className={`flex flex-col w-full ${isAr ? "max-lg:items-center max-lg:text-center lg:items-center lg:text-center" : "items-center lg:items-start"}`}
            >
              <h3 className="text-black font-semibold uppercase tracking-wide text-sm mb-3">
                {t("footer.quickLink")}
              </h3>
              <nav
                className={`flex flex-col gap-2 text-sm ${isAr ? "items-center text-center" : ""}`}
              >
                <Link
                  href="/"
                  className="text-black/80 hover:text-[#BF822E] transition-colors font-medium"
                >
                  {t("footer.home")}
                </Link>
                <Link
            ...
            <div
              className={`flex flex-col w-full ${isAr ? "max-lg:items-center max-lg:text-center lg:items-start lg:text-right" : "items-center lg:items-start text-center lg:text-left"}`}
            >
              <h4 className="text-black font-semibold uppercase tracking-wide text-sm mb-2">
                {t("footer.subscribe")}
              </h4>
              ...
              <form
                ...
                className={`flex gap-2 w-full max-w-[280px] mb-5 ${isAr ? "flex-row-reverse max-lg:mx-auto lg:mx-0" : "mx-auto lg:mx-0"}`}
              ...
              <h4 className="text-black font-semibold uppercase tracking-wide text-sm mb-3">
                {t("footer.followUs")}
              </h4>
              <div
                className={`flex gap-2 ${isAr ? "max-lg:justify-center lg:justify-start" : ""}`}
              >
                <a
                  href="https://www.facebook.com/thecirclesociety.ae/"
                  target="_blank"
                ...
                <a
                  href="https://www.instagram.com/thecirclesociety.ae/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 rounded-lg bg-black/5 hover:bg-black/10 transition"
                ...
                <a
                  href="https://www.tiktok.com/@thecirclesociety.ae"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 rounded-lg bg-black/5 hover:bg-black/10 transition"
                  aria-label="TikTok"
                ...
                <a
                  href="https://www.linkedin.com/company/thecirclesocietyae/about/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 rounded-lg bg-black/5 hover:bg-black/10 transition"
                  aria-label="TikTok"
      ...
      <div
        className="border-t border-[#E8E5E0] px-6 py-4 lg:pl-24"
        dir={isAr ? "rtl" : undefined}
      >
        <div
          className={`mx-auto max-w-7xl flex flex-col sm:flex-row items-center justify-center gap-3 text-sm text-black/70 ${isAr ? "sm:flex-row-reverse sm:justify-between" : "sm:justify-between"}`}
        >
          <p>
            © {t("footer.rights")}{" "}
            {isAr
          ...
          <nav className="flex flex-wrap items-center justify-center gap-x-4 gap-y-1">
            ...
            >
              <span
                className="text-black group-hover:text-[#BF822E] transition-colors"
                aria-hidden
              >
                •
              </span>
